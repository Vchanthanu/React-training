        ...
        return (
            <div className="card">
                ...
                <span className="subcard right">
                    ...
                    <h4 className="carditem"><button className="left" onClick={this.updateproduct}>Update</button><button className="right"
                        onClick={this.deleteproduct}>Delete</button></h4>
                </span>
            </div>
        );
    }
